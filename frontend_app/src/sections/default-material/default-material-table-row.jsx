...
export function DefaultMaterialTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, onViewRow, onReturnList }) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title="Delete"
        content={`Are you sure want to delete material: (${row.name})?`}
        action={
