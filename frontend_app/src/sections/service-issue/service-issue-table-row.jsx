...
export function ServiceIssueTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, onViewRow, onReturnList }) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title="Delete"
        content={`Are you sure want to delete project service issue: (${row.name})?`}
        action={
