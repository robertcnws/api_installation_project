...
const reportsType = [
    ...
    { value: "previousDay", label: "Previous Day Report" },
    { value: "previousWeek", label: "Previous Week Report" },
    { value: "previousMonth", label: "Previous Month Report" },
    { value: "previousYear", label: "Previous Year Report" },
