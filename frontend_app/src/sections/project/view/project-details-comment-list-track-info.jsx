...
import ProjectDetailsCommentListJsonDisplay from './project-details-comment-list-json-display';

export function ProjectDetailsCommentListTrackInfo({ comment }) {
    ...
    return (
        <Typography component="div" variant="body2" sx={{ fontSize: 'small', mr: 15 }}>
            ...
            {comment.managedData && (
                <>
                    <br />
                    <ProjectDetailsCommentListJsonDisplay
