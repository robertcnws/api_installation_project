...
import { KanbanProjectTaskAdd } from '../components/kanban-project-task-add';
import { KanbanProjectColumnToolBar } from './kanban-project-column-toolbar';

// ----------------------------------------------------------------------

export function KanbanProjectColumn({ children, column, tasks, disabled, sx }) {
  ...
  const percentage = tasks.reduce((acc, task) => acc + task.percentage, 0) / tasks.length || 0;
