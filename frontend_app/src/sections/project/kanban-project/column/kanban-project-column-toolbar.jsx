...
import { KanbanProjectInputName } from '../components/kanban-project-input-name';

// ----------------------------------------------------------------------

export function KanbanProjectColumnToolBar({
  columnName,
  totalTasks,
  percentage,
  handleProps,
    ...
    <>
      <Stack direction="row" alignItems="center">
        ...
        <KanbanProjectInputName
          ...
          sx={{ mx: 1, borderColor: 'transparent', bgcolor: 'transparent', color: 'grey' }}
          disabled
        />
