  ...
  return (
    <Card sx={{
      ...
      {[
        {
          label: 'SO Number',
          value: measurement?.salesOrder?.salesorder_number,
          icon: <Iconify
        ...
        {
          label: 'Client',
          value: measurement?.salesOrder?.customer_name || measurement?.client?.name,
          icon: <Iconify
            icon="ix:customer-filled"
            sx={{ color: 'text.primary' }}
          />,
          hasValue: measurement?.salesOrder?.customer_name?.length > 0 || measurement?.client?.name?.length > 0,
        },
        {
          label: 'Address',
        ...
        },
        {
          ...
          value: (measurement?.salesOrder?.customer || measurement?.salesOrder?.contact_person_details)?.phone ||
            ...
            measurement?.phone || measurement?.client?.phone,
          icon: <Iconify
          ...
          hasValue: (measurement?.salesOrder?.customer || measurement?.salesOrder?.contact_person_details)?.phone?.length > 0 ||
            ...
            measurement?.phone?.length > 0 || measurement?.client?.phone?.length > 0,
        },
        {
          label: 'Order Date',
                ...
                <Tooltip title={(measurement?.salesOrder?.customer || measurement?.salesOrder?.contact_person_details)?.phone ||
                  ...
                  <IconButton
                    ...
                    color={(measurement?.salesOrder?.customer || measurement?.salesOrder?.contact_person_details)?.phone ||
                      (measurement?.salesOrder?.customer || measurement?.salesOrder?.contact_person_details)?.mobile ||
                      measurement?.phone || measurement?.client?.phone ? "primary" : "warning"}
                    size="small"
                    sx={{
                      ml: 1,
                      '&:hover': {
