...
export function StageTaskTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, onViewRow, onReturnList }) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title="Delete"
        content={`Are you sure want to delete task stage: (${row.name})?`}
        action={
