...
export function ServiceDetailsContentOverviewTableIssuesMobile({
    serviceItems,
    selectedListItems,
                            ...
                            <TableRow key={product.line_item_id}>
                                <TableCell>
                                    <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', gap: 1 }}>
                                        <Typography variant="caption" color="text.secondary" sx={{ mb: 1 }}>Product</Typography>
                                                ...
                                                {product.issues.map((issue, index) => (
                                                    <ListItem key={`${product.line_item_id}-${issue.id}`}>
                                                        <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', gap: 1 }}>
                                                            ...
                                                            />
                                                            <Box sx={{ display: 'flex', flexDirection: 'row', gap: 0, maxWidth: 100, justifyContent: 'flex-start' }}>
