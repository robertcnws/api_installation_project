...
export function ServiceAttachmentsFilters({
  filters,
  loadedUsers,
  options,
  dateError,
            ...
            <MenuList sx={{ p: 0 }}>
              <MenuItem sx={{ p: 0.5 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', p: 0, mt: 1, ml: 1 }}>
                  <Tooltip title="Search service(s) by NAME, NUMBER, CUSTOMER, RESPONSIBLE...">
                    <TextField
