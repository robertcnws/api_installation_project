...
import ServiceDetailsCommentListJsonDisplay from './service-details-comment-list-json-display';

export function ServiceDetailsCommentListTrackInfo({ comment }) {
    ...
    return (
        <Typography component="div" variant="body2" sx={{ fontSize: 'small', mr: 15 }}>
            ...
            {comment.managedData && (
                <>
                    <br />
                    <ServiceDetailsCommentListJsonDisplay
