...
export function ServiceEditModalInstallationTeamView({
    isEdit,
    service,
    open,
    onClose,
    ...
    const defaultValues = useMemo(
        () => ({
            ...
            installer: getServiceInstaller(service, CONFIG) || null,
        }),
        [service]
    );
    ...
    }, [cleanLoadedUsers, service]);

    const onSubmit = handleSubmit(async (data) => {
        const formData = new FormData();
        formData.append('userReporter', JSON.stringify(userLogged?.data));

        formData.append('userServiceTeam', JSON.stringify(data.installer));

        const promise = axios.post(`${CONFIG.apiUrl}/services/update/service/${service?.id}/change-users-team/`, formData, {
            headers: {
