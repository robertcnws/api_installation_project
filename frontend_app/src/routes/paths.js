...
export const paths = {
  ...
  dashboard: {
    ...
    general: {
      ...
      liveMonitor: `${ROOTS.DASHBOARD}/live-monitor`,
    ...
    rol: {
      root: `${ROOTS.DASHBOARD_CONFIG}/rol`,
      list: `${ROOTS.DASHBOARD_CONFIG}/rol/list`,
      new: `${ROOTS.DASHBOARD_CONFIG}/rol/new`,
      details: (id) => `${ROOTS.DASHBOARD_CONFIG}/rol/${id}`,
      edit: (id) => `${ROOTS.DASHBOARD_CONFIG}/rol/${id}/edit`,
    },
    product: {
