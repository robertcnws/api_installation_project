...
from api_measurements.ws_urls import websocket_urlpatterns as measurement_websocket_urlpatterns

os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'system_installation_project.settings')
django.setup()

urlpatterns = project_websocket_urlpatterns + user_websocket_urlpatterns + service_websocket_urlpatterns + measurement_websocket_urlpatterns
